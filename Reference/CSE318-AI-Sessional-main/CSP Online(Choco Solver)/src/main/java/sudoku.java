...
// 3. Post constraints
        ...
        //IntVar tmp = (IntVar) bd[0][2].neg().add(11);
        //model.arithm(bd[0][0] , "+" , bd[0][1] ,  "=" , (IntVar) bd[0][2].neg().add(11)).post();
        ...
        model.sum(new IntVar[]{bd[4][6], bd[3][6], bd[3][7], bd[3][8], bd[4][8]}, "=", 30).post();
